...
def batch_net(params, layer, key, train, conv_filters, return_params=False):
    ...
    for dilation in [1,2,4,2,1,1,2,1]: #dilated layers in sequence
        ...
        layer, params = ml.VN_nonlinear(params, layer, scalar_activation=jax.nn.tanh, mold_params=return_params)
...
print('Full Test loss:', map_and_loss(dict(params), test_X, test_Y, None, None, conv_filters=conv_filters))
